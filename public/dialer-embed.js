(function () {
  ...
  style.textContent = [
    ...
    '#_3cx_tab_history{overflow-y:auto;max-height:340px;}',
    ...
    'padding:10px 14px;border-bottom:1px solid #e5e7eb;transition:background .15s;}',
    '._3cx_hi:hover{background:#f9fafb;}',
    '._3cx_hin{display:flex;flex-direction:column;gap:2px;}',
    '._3cx_hnum{font-size:13px;font-weight:700;color:#111827;}',
    '._3cx_hm{display:flex;align-items:center;gap:5px;font-size:10px;color:#6b7280;}',
