...
const Widget = sequelize.define('Widget', {
  ...
  agent_display_mode:   { type: DataTypes.STRING, defaultValue: 'circle' },
  agent_full_image_url: { type: DataTypes.STRING, allowNull: true },
  side_graphic_url:     { type: DataTypes.STRING, allowNull: true },
  slider_auto_play:     { type: DataTypes.BOOLEAN, defaultValue: true },
  slider_interval_sec: { type: DataTypes.INTEGER, defaultValue: 4 },
